...
COMPILER_FLAGS		=	-Wall -c  -I~/vcpkg/installed/x64-linux/include -L~/vcpkg/installed/x64-linux/lib -std=c++17 -fpic -o
LINKER_FLAGS		=	-shared
LINKER_DEPENDENCIES	=   -L/usr/lib/ -I/usr/include/ -I~/vcpkg/installed/x64-linux/include -L~/vcpkg/installed/x64-linux/lib -lphpcpp -lcpr -lcurl -lssl -lcrypto -lz -lpthread
